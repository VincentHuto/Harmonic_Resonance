...
public class TileEntitySlimeRepelent extends BlockEntity implements TickableBlockEntity {
	...
	@Override
	public void tick() {
		repel(world, new AxisAlignedBB(pos.add(-4, -4, -4), pos.add(4, 4, 4)), pos.getX() + 0.5, pos.getY() + 0.5,
				pos.getZ() + 0.5);
	}
