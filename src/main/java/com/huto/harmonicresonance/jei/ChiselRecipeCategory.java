...
public class ChiselRecipeCategory implements IRecipeCategory<RecipeChiselStation> {
	public static final ResourceLocation UID = new ResourceLocation(HarmonicResonance.MOD_ID, "runic_chisel_station");
	...
	private static final ResourceLocation GUI_Chisel = new ResourceLocation(
			HarmonicResonance.MOD_ID + ":textures/gui/chisel_station.png");
