...
import com.huto.harmonicresonance.recipe.RecipeHarmonizer;
import com.huto.harmonicresonance.tile.util.EnumCrystalTypes;
...
public class HarmonizerRecipeCategory implements IRecipeCategory<RecipeHarmonizer> {
	...
	public static final ResourceLocation UID = new ResourceLocation(HarmonicResonance.MOD_ID, "crystal_harmonizer");
