...
public class TileEntityInit {
	...
	public static final RegistryObject<BlockEntityType<TileEntityTeleporter>> teleporter = TILES.register("teleporter",
			() -> BlockEntityType.Builder.create(TileEntityTeleporter::new, BlockInit.teleporter.get()).build(null));
