...
//	public static List<GuiTomePage> AdornmentsPageList = new ArrayList<GuiTomePage>();
	...
	public static String INTRO_PAGE_3 = "One of the quirks of the antimatter/matter duality is that the vibrations of these particles are opposite and equal as well. These vibrations follow the same principle that all other forms of vibration be it sound/light/electricity etc, in that they amplify when met with similar waves and cancel when met with opposing waves. Building on the concentration effect of these vibrations, the idea of karma can even be traced back as the balance of these vibrations within your body, and vibratory is just the net force of the anti and positive waves manifesting as a physical and invisible force.";
	...
	// Adornments
	/*
	 * public static String ADORNMENTS_PAGE_1 =
	 * "title.somnolenttome.runes.page.1.text"; public static String
	 * ADORNMENTS_PAGE_2 = "title.somnolenttome.runes.page.2.text";
	 */
	// Karma
	...
	public static void registerPages() {
		...
		IntroPageList
				.add(new GuiTomeImagePage(8, EnumTomeCatagories.INTRO, "ImageTest", "Picture Yo", "", new GuiTomeImage(
						new ResourceLocation(HarmonicResonance.MOD_ID, "textures/gui/pageimages/blue.png"), 0, 0)));
		...
		IntroPageList.add(new GuiTomeImagePage(9, EnumTomeCatagories.INTRO, "ImageTest2", "Pictures Yo", "",
				new GuiTomeImage(new ResourceLocation(HarmonicResonance.MOD_ID, "textures/gui/pageimages/altar1.png"), 0,
						0),
				new GuiTomeImage(new ResourceLocation(HarmonicResonance.MOD_ID, "textures/gui/pageimages/altar2.png"), 1,
						1),
				new GuiTomeImage(new ResourceLocation(HarmonicResonance.MOD_ID, "textures/gui/pageimages/altar3.png"), 2,
						2),
				new GuiTomeImage(new ResourceLocation(HarmonicResonance.MOD_ID, "textures/gui/pageimages/altar4.png"), 3,
						3),
				new GuiTomeImage(new ResourceLocation(HarmonicResonance.MOD_ID, "textures/gui/pageimages/altar5.png"), 4,
						4),
				new GuiTomeImage(new ResourceLocation(HarmonicResonance.MOD_ID, "textures/gui/pageimages/blue.png"), 5,
						5),
				new GuiTomeImage(new ResourceLocation(HarmonicResonance.MOD_ID, "textures/gui/pageimages/red.png"), 6, 6),
				new GuiTomeImage(new ResourceLocation(HarmonicResonance.MOD_ID, "textures/gui/pageimages/green.png"), 7,
						7),
				new GuiTomeImage(new ResourceLocation(HarmonicResonance.MOD_ID, "textures/gui/pageimages/white.png"), 8,
						8),
				new GuiTomeImage(new ResourceLocation(HarmonicResonance.MOD_ID, "textures/gui/pageimages/black.png"), 9,
						9),
				new GuiTomeImage(new ResourceLocation(HarmonicResonance.MOD_ID, "textures/gui/pageimages/blue.png"), 10,
						10),
				new GuiTomeImage(new ResourceLocation(HarmonicResonance.MOD_ID, "textures/gui/pageimages/red.png"), 11,
						11, textIn)));
		IntroPageList.add(new GuiTomeImagePage(10, EnumTomeCatagories.INTRO, "ImageTest3", "Stretchy Yo", "",
				new GuiTomeImage(
						new ResourceLocation(HarmonicResonance.MOD_ID, "textures/gui/pageimages/horizextend1.png"), 0, 0,
						128, 64),
				new GuiTomeImage(new ResourceLocation(HarmonicResonance.MOD_ID, "textures/gui/pageimages/scaled1.png"), 1,
						3, 128, 128),
				new GuiTomeImage(
						new ResourceLocation(
								HarmonicResonance.MOD_ID, "textures/gui/pageimages/vertextend1.png"), 6, 8,
						64, 128)));
