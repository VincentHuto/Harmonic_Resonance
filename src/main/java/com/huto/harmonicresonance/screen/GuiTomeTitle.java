...
public class GuiTomeTitle extends Screen {
	...
	final ResourceLocation texture = new ResourceLocation(HarmonicResonance.MOD_ID, "textures/gui/newbook.png");
...
//	final int BUTTONRED = 5;
	...
	GuiButtonTextured buttonclose, whiteButton, yellowButton, blueButton, greenButton, orangeButton, cyanButton,
			darkBlueButton, eyeButton;
	boolean isElder;
...
//			mc.getRenderManager().renderEntityStatic(CowEntity, 1, 0, 0, 0, partialTicks, matrixStack,null, 2);
			...
			mc.getRenderManager().renderEntityStatic(
					new EntityColin(EntityInit.colin.get(), ClientUtils.getClientPlayer().getEntityWorld()), 1, 0, 0,
					33, 0, matrixStack, bufferIn, 0);
		 ...
		 * StringTextComponent("Adornments"), mouseX, mouseY); }
		 */
