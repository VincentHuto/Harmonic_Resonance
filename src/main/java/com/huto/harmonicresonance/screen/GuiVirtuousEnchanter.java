...
@OnlyIn(Dist.CLIENT)
public class GuiVirtuousEnchanter extends AbstractContainerScreen<ContainerVirtuousEnchanter> {
	private static final ResourceLocation ENCHANTMENT_TABLE_BOOK_TEXTURE = new ResourceLocation(
			HarmonicResonance.MOD_ID, "textures/entity/virtuous_table_book.png");
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(HarmonicResonance.MOD_ID,
	...
	public GuiVirtuousEnchanter(ContainerVirtuousEnchanter screenContainer, Inventory inv,
			Component titleIn) {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int mouseX, int mouseY) {
		this.font.drawString(matrixStack, this.title.toString(), (float) this.titleX, (float) this.titleY, 7804791);

		if (contain.getEnchantingType() != null) {
			this.font.drawString(matrixStack,
					new StringTextComponent(TextFormatting.ITALIC + contain.getEnchantingType().toString()).toString(),
					(float) this.titleX + 100, (float) this.titleY, 7804791);
		}
		this.font.drawString(matrixStack, this.playerInventory.getDisplayName().toString(),
				(float) this.playerInventoryTitleX, (float) this.playerInventoryTitleY, 7804791);
	}
