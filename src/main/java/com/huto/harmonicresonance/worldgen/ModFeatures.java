...
public class ModFeatures {
	...
	public static final RandomPatchConfiguration BREAKOUT_POINT = (new RandomPatchConfiguration.GrassConfigurationBuilder(
			new SimpleStateProvider(BlockInit.essence_breakout_point.get().getDefaultState()),
	...
	public static void setup() {
		...
		Registry.register(r, new ResourceLocation(HarmonicResonance.MOD_ID, "breakout_point"), BREAKOUT_POINT_FEATURE);
		Registry.register(r, new ResourceLocation(HarmonicResonance.MOD_ID, "null_breakout_point"),
				NULL_BREAKOUT_POINT_FEATURE);
