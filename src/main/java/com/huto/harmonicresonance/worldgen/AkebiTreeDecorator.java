...
public class AkebiTreeDecorator extends TreeDecorator {
	...
	public void func_225576_a_(WorldGenLevel seedReader, Random rand, List<BlockPos> listBlockPos,
			List<BlockPos> p_225576_4_, Set<BlockPos> setBlockPos, BoundingBox boundingBox) {
