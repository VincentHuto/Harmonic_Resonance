...
public class ChunkVibrationEvents {
	...
	public static void attachChunkCapabilities(final AttachCapabilitiesEvent<LevelChunk> event) {
		...
		event.addCapability(new ResourceLocation(HarmonicResonance.MOD_ID, "chunk_energy"),
				new SerializableCapabilityProvider<>(ChunkVibrationProvider.CHUNK_ENERGY_CHUNK_CAPABILITY, null,
						chunkEnergy));
