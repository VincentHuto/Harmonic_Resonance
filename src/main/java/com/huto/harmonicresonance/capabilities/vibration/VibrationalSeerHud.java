...
public class VibrationalSeerHud extends Screen {
	...
	public VibrationalSeerHud(LocalPlayer playerIn, Minecraft mcI) {
	...
	public void renderStatusBar(PoseStack matrix, int screenWidth, int screenHeight, Level world,
		...
		GuiUtils.drawTexturedModalRect(-130, -5, 0, 0, newBarWidth + 2, BAR_HEIGHT + 2);
		GL11.glPopMatrix();
		...
		if (this.absVibes <= 300) {
			...
			GL11.glScalef(0.75F, 0.75F, 0.75F);
			GuiUtils.drawTexturedModalRect(-130, 0, 0, 0, newBarWidth, BAR_HEIGHT);
			// Purple Bar
			...
			// Black
			GL11.glColor4f(0.0F, 0.0F, 0.0F, 0.0F);
			GuiUtils.drawTexturedModalRect(-131, -16, 0, 0, newBarWidth2 + 2, BAR_HEIGHT + 2);
			// Purple
			GL11.glColor4f(1.0F, 0.0F, 1.0F, 0.0F);
			GuiUtils.drawTexturedModalRect(-130, -15, 0, 0, newBarWidth2, BAR_HEIGHT);
		} else {
			// Blue
			GL11.glTranslatef(vanillaExpLeftX - 39, vanillaExpTopY - BAR_SPACING_ABOVE_EXP_BAR - BAR_HEIGHT + 8, 0);
			GL11.glScalef(0.75F, 0.75F, 0.75F);
			...
			// Black
			GL11.glColor4f(0.0F, 0.0F, 0.0F, 0.0F);
			GuiUtils.drawTexturedModalRect(-131, -31, 0, 0, newBarWidth3 + 2, BAR_HEIGHT + 2);
			// Red
			GL11.glColor4f(1.0F, 0.0F, 0.0F, 0.0F);
			GuiUtils.drawTexturedModalRect(-130, -30, 0, 0, newBarWidth3, BAR_HEIGHT);
		}
