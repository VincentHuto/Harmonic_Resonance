...
import com.huto.harmonicresonance.init.DimensionInit;
...
public class KarmaEvents {
	...
	public static void attachCapabilitiesEntity(final AttachCapabilitiesEvent<Entity> event) {
		if (event.getObject() instanceof Player) {
			event.addCapability(new ResourceLocation(HarmonicResonance.MOD_ID, "karma"), new KarmaProvider());
		}
	}
	...
	public static void playerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
		...
		IKarma karma = player.getCapability(KarmaProvider.KARMA_CAPA).orElseThrow(NullPointerException::new);
		PacketHandler.CHANNELKARMA.send(PacketDistributor.PLAYER.with(() -> player), new KarmaPacketServer(karma));
		if (karma.isActive()) {
