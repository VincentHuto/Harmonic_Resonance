package com.huto.harmonicresonance.container;
...
public class ContainerVirtuousEnchanter extends AbstractContainerMenu {

	public final Container tableInventory = new SimpleContainer(2) {
	...
	public ContainerVirtuousEnchanter(final int windowId, final PlayerInventory playerInv,
		...
		this.addSlot(new Slot(tableInventory, 1, 35, 47) {
			...
			public boolean isItemValid(ItemStack stack) {
				if (ItemTags.getCollection().get(new ResourceLocation(HarmonicResonance.MOD_ID, "mod_gems"))
	...
	public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			} else if (ItemTags.getCollection().get(new ResourceLocation(HarmonicResonance.MOD_ID, "mod_gems"))
