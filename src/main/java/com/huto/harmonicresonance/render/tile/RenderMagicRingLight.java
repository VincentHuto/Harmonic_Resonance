...
public class RenderMagicRingLight extends BlockEntityRenderer<TileEntityMagicRingLight> {
	public RenderMagicRingLight(BlockEntityRenderDispatcher p_i226006_1_) {
		super(p_i226006_1_);
	}

	@Override
	public void render(TileEntityMagicRingLight lightTile, float v, PoseStack matrixStack,
			MultiBufferSource iRenderTypeBuffer, int i, int i1) {
