...
public class RenderResonator extends BlockEntityRenderer<TileEntityVibeResonator> {
	private final ModelDrumMagatama magatamas = new ModelDrumMagatama();

	public RenderResonator(BlockEntityRenderDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@SuppressWarnings("deprecation")
	@Override
	public void render(TileEntityVibeResonator te, float partialTicks, PoseStack matrixStackIn,
