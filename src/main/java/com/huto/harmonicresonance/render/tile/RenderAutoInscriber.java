...
public class RenderAutoInscriber extends BlockEntityRenderer<TileEntityAutoInscriber> {
	private final ModelDrumMagatama magatamas = new ModelDrumMagatama();

	public RenderAutoInscriber(BlockEntityRenderDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@SuppressWarnings({ "deprecation", "unused" })
	@Override
	public void render(TileEntityAutoInscriber te, float partialTicks, PoseStack matrixStackIn,
