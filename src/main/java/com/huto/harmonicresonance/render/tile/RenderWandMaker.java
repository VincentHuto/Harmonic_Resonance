...
public class RenderWandMaker extends BlockEntityRenderer<TileEntityWandMaker> {
	private final ModelDrumMagatama magatamas = new ModelDrumMagatama();
	public static final ResourceLocation GLASSTEXTURE = new ResourceLocation(HarmonicResonance.MOD_ID,
			"textures/block/machine_glass.png");

	public RenderWandMaker(BlockEntityRenderDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@SuppressWarnings("deprecation")
	@Override
	public void render(TileEntityWandMaker te, float partialTicks, PoseStack matrixStackIn,
		...
		// RenderShapes.renderSizedTunnels(matrixStackIn, bufferIn, combinedLightIn,
		// combinedOverlayIn,
		// bufferIn.getBuffer(RenderType.getEntityTranslucent(GLASSTEXTURE)),3, 2, 1, 1,
		// 3, 2, 2);
