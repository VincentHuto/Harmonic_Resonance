...
public class RenderAbsorber extends BlockEntityRenderer<TileEntityAbsorber> {
	...
	public RenderAbsorber(BlockEntityRenderDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@SuppressWarnings("deprecation")
	@Override
	public void render(TileEntityAbsorber te, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn,
	...
	public static void drawLasers(MatrixStack matrixStackIn, SetMultimap<BlockPos, BlockPos> lasers, float r, float g,
		...
		builder = buffer.getBuffer(ModRenderTypeInit.LASER_MAIN_ADDITIVE);
		...
		matrixStackIn.pop();
		buffer.finish(ModRenderTypeInit.LASER_MAIN_ADDITIVE);
	}
