...
public class RenderVibeFuser extends BlockEntityRenderer<TileEntityVibeFuser> {
	private final ModelDrumMagatama magatamas = new ModelDrumMagatama();

	public RenderVibeFuser(BlockEntityRenderDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@SuppressWarnings("deprecation")
	@Override
	public void render(TileEntityVibeFuser te, float partialTicks, PoseStack matrixStackIn,
