...
public class RenderCelestialActuator extends TileEntityRenderer<TileEntityCelestialActuator> {

	ModelFloatingDial dial = new ModelFloatingDial();

	public RenderCelestialActuator(TileEntityRendererDispatcher rendererDispatcherIn) {
