...
public class RenderVirtuousEnchanter extends BlockEntityRenderer<TileEntityVirtuousEnchant> {
	/** The texture for the book above the enchantment table. */
	public static final ResourceLocation NEW_TEXTURE_BOOK = new ResourceLocation(HarmonicResonance.MOD_ID,
			"textures/entity/virtuous_table_book.png");
	private final BookModel modelBook = new BookModel();

	public RenderVirtuousEnchanter(BlockEntityRenderDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@Override
	public void render(TileEntityVirtuousEnchant tileEntityIn, float partialTicks, PoseStack matrixStackIn,
