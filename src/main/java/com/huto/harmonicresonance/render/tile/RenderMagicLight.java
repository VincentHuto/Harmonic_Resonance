...
public class RenderMagicLight extends BlockEntityRenderer<TileEntityMagicLight> {
	public RenderMagicLight(BlockEntityRenderDispatcher p_i226006_1_) {
		super(p_i226006_1_);
	}

	@Override
	public void render(TileEntityMagicLight lightTile, float v, PoseStack matrixStack,
