...
public class RenderKarmicAltar extends BlockEntityRenderer<TileEntityKarmicAltar> {

	public RenderKarmicAltar(BlockEntityRenderDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@SuppressWarnings("deprecation")
	@Override
	public void render(TileEntityKarmicAltar te, float partialTicks, PoseStack matrixStackIn,
