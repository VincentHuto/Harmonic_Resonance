...
public class RenderThermalInfluxer extends BlockEntityRenderer<TileEntityThermalInfluxer> {
	private final ModelFloatingCube cube = new ModelFloatingCube();

	public RenderThermalInfluxer(BlockEntityRenderDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@Override
	public void render(TileEntityThermalInfluxer te, float partialTicks, PoseStack matrixStackIn,
