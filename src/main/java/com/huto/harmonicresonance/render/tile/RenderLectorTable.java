...
import com.huto.harmonicresonance.render.effects.LectorVectorColorData;
...
public class RenderLectorTable extends BlockEntityRenderer<TileEntityLectorTable> {
	...
	public RenderLectorTable(BlockEntityRenderDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@Override
	public void render(TileEntityLectorTable te, float partialTicks, PoseStack matrixStackIn,
