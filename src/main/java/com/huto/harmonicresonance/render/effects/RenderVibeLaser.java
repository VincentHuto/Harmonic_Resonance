package com.huto.harmonicresonance.render.effects;
...
public class RenderVibeLaser {
	...
	private static void drawLasers(RenderWorldLastEvent event, Vector3d from, RayTraceResult trace, double xOffset,
		...
		builder = buffer.getBuffer(ModRenderTypeInit.LASER_MAIN_BEAM);
		...
		// core
		builder = buffer.getBuffer(ModRenderTypeInit.LASER_MAIN_CORE);
