...
public class LayerColinDeath extends RenderLayer<EntityColin, ModelColin> {
	private static float constant = (float) (Math.sqrt(3.0D) / 2.0D);
	private static ResourceLocation DRAGON_EXPLODING_TEXTURES = new ResourceLocation(HarmonicResonance.MOD_ID,
			"textures/entity/colin/modelcolin_exploding.png");
	protected static ResourceLocation TEXTURE = new ResourceLocation(HarmonicResonance.MOD_ID,
