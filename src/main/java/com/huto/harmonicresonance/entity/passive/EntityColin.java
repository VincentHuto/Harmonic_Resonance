...
import com.huto.harmonicresonance.sound.ModSoundHandler;
...
public class EntityColin extends MonsterEntity {
	...
	protected SoundEvent getAmbientSound() {
		return ModSoundHandler.ENTITY_COLIN_AMBIENT;
	}

	@Override
	protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
		return ModSoundHandler.ENTITY_COLIN_HURT;

	}

	@Override
	protected SoundEvent getDeathSound() {
		return ModSoundHandler.ENTITY_COLIN_DEATH;
