...
public class EntityIbis extends Animal {
	private static final EntityDataAccessor<Integer> IBIS_TYPE = SynchedEntityData.createKey(EntityIbis.class,
	...
	public static final Map<Integer, ResourceLocation> TEXTURE_BY_ID = Util.make(Maps.newHashMap(), (p_213410_0_) -> {
		p_213410_0_.put(0, new ResourceLocation(HarmonicResonance.MOD_ID, "textures/entity/ibis/model_ibis_red.png"));
		p_213410_0_.put(1, new ResourceLocation(HarmonicResonance.MOD_ID, "textures/entity/ibis/model_ibis_grey.png"));
		p_213410_0_.put(2, new ResourceLocation(HarmonicResonance.MOD_ID, "textures/entity/ibis/model_ibis_brown.png"));
	});
	...
	@Override
	public EntityIbis createChild(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
