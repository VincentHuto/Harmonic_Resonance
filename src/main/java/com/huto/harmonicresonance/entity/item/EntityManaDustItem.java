package com.huto.harmonicresonance.entity.item;
...
public class EntityManaDustItem extends ItemEntity {
	...
	public EntityManaDustItem(EntityType<? extends ItemEntity> p_i50217_1_, Level world) {
		super(p_i50217_1_, world);

	}

	public EntityManaDustItem(EntityType<? extends ItemEntity> p_i50217_1_, Level p_i50217_2_, double posX, double posY,
