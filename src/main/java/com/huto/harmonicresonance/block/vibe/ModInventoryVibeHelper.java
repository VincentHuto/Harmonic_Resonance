...
import com.huto.harmonicresonance.tile.vibration.func.InvWithLocation;
...
public class ModInventoryVibeHelper {
	...
	public static InvWithLocation getInventoryWithLocation(Level world, BlockPos pos) {
	...
	public static IItemHandler getInventory(Level world, BlockPos pos) {
